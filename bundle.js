...
function factorial(n) {
  var _factorial = function myself(acc, n) {
    return n.greater(0)
      ? bilby.cont( function() { return myself(acc.times(n), n.minus(1)); })
      : bilby.done(acc);
  };

  return bilby.trampoline(_factorial(bigInt.one, bigInt(n)));
}

module.exports = factorial;
},{"big-integer":2,"bilby":3}],2:[function(require,module,exports){
﻿var bigInt = (function () {
